    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a class="nav-link scrollto" href="#main"><span>About Us</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a class="nav-link scrollto" href="#values">Our Values</a></li>
              <li><a class="nav-link scrollto" href="#meet-the-team">Meet the Team</a></li>
            </ul>
          </li>
          <!--
    ...
    <section id="about" class="about gallery">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <!--
          <a href="#about" class="btn-get-started scrollto">Learn More <i class="bx bx-chevron-right"></i></a>
          -->
        </div>
      ...
      <div class="container-fluid" id="values">
        ...
        <div class="row">
          <div class="col-xl-12 col-lg-12 d-flex justify-content-center align-items-stretch position-relative">
            <div id="ytplayer" style="border-radius: 20px;"></div>
          </div>
          <!-- <div class="col-xl-12 col-lg-12 video-box d-flex justify-content-center align-items-stretch position-relative"> -->
            <!-- <a href="https://www.youtube.com/watch?v=ve_wKlFPy08" class="glightbox play-btn mb-4"></a> -->
            <!--  --> <!-- {{ asset ('assets/vid/ourteam_1.mp4') }} -->
          <!-- </div> -->
          ...
          <div class="col-xl-12 col-lg-12 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            ...
            <div class="icon-box col-lg-4 col-md-12" data-aos="fade-right" data-aos-delay="100" data-aos-duration="700">
              <div class="icon"><i class="trusted-icon"></i></div>
              <h4 class="title"><a>Trusted</a></h4>
              <p class="description">
            ...
            <div class="icon-box col-lg-4 col-md-12" data-aos="fade-right" data-aos-delay="100" data-aos-duration="700">
              <div class="icon"><i class="teamwork-icon"></i></div>
              <h4 class="title"><a>Teamwork</a></h4>
              <p class="description">
            ...
            <div class="icon-box col-lg-4 col-md-12" data-aos="fade-right" data-aos-delay="100" data-aos-duration="700">
              <div class="icon"><i class="commited-icon"></i></div>
              <!-- <i class="bx bx-target-lock"></i> -->
              <h4 class="title"><a>Committed</a></h4>
              <p class="description">
            ...
            <div class="icon-box col-lg-4 col-md-12" data-aos="fade-right" data-aos-delay="100" data-aos-duration="700"> 
              <div class="icon"><i class="flexible-icon"></i></div>
              <h4 class="title"><a>Flexible</a></h4>
              <p class="description">
      ...
      <div class="container" id="meet-the-team">
        ...
        <div class="section-title">
          <h2 style="margin-top: 20px;">Meet the Team</h2>
          <!-- <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea. Quia fugiat sit in iste officiis commodi quidem hic quas.</p> -->
        </div>

        <div class="row text-center">
          <div class="bod-wrap" data-aos="fade-right" data-aos-delay="100" data-aos-duration="700">
            <div class="bod-item">
              <img src="{{ asset ('assets/img/bod-list/Dien Natalia.webp') }}" class="bod-img" alt="">
              <h3>Dien Natalia</h3>
              <h4>CEO</h4>
              <p>
                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                Dien started Optimus with over a decade of remarkable experience in human capital and IT industries. Her expertise includes recruitment,
                training, assessment, and outsourcing. Settling the longest period in the field of sales in numbers of national HR companies, she led
                her teams to meet the needs of her then-happy clients. Her current teammates value her integrity and her habit of cherishing people around her.
                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
              </p>
              <!--
              <div class="learn-more">
                <a href="/soon" class="more-btn galelry-lightbox">Learn More <i class="bx bx-chevron-right"></i></a>
              </div> -->
              <div class="social">
                <a href="mailto:hello@consultwithoptimus.id"><i class="ri-mail-fill"></i></a>
                <a href="https://www.instagram.com/dien.natalia/"><i class="ri-instagram-fill"></i></a>
                <a href="https://www.linkedin.com/in/dien-natalia-81213721/"> <i class="ri-linkedin-box-fill"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="bod-wrap" data-aos="fade-right" data-aos-delay="100" data-aos-duration="700">
            <div class="bod-item">
              <img src="{{ asset ('assets/img/bod-list/Toman Alberto.webp') }}" class="bod-img" alt="">
              <h3>Toman Alberto</h3>
              <h4>Co-Founder & Director</h4>
              <p>
                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                Toman is a relatively newcomer in the human capital industry. Graduated
                with an engineering degree from ITB, Toman has 10 years’ experience in the oil
                and gas industry. In 2017, Toman started his journey in one of the
              ...
              <div class="social">
                <a href="mailto:hello@consultwithoptimus.id"><i class="ri-mail-fill"></i></a>
                <a href="https://www.instagram.com/tomanalberto/"><i class="ri-instagram-fill"></i></a>
                <a href="https://www.linkedin.com/in/toman-alberto-70997345/"> <i class="ri-linkedin-box-fill"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="bod-wrap" data-aos="fade-right" data-aos-delay="100" data-aos-duration="700">
            <div class="bod-item">
              <img src="{{ asset ('assets/img/bod-list/Raymond Koh.webp') }}" class="bod-img" alt="">
              <h3>Raymond Koh</h3>
              <h4>Co-Founder & BD</h4>
              <p>
                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                Raymond is a young-outgoing co-founder of Optimus. Currently, he also acts as a Client Account Manager. Always interested in HR and
                technology, Raymond started his career as a LinkedIn Talent Solution associate and account executive in an HR recruitment company. He
                then gained some international work experience with his former IT solutions company. He then joined Dien Natalia, establishing Optimus
                Consulting. Until now, he is really into his dynamic work-life at Optimus.
                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
              </p>
              <!--
              <div class="learn-more">
              ...
              <div class="social">
                <a href="mailto:hello@consultwithoptimus.id"><i class="ri-mail-fill"></i></a>
                <a href="https://www.instagram.com/raymondkohh/"><i class="ri-instagram-fill"></i></a>
                <a href="https://www.linkedin.com/in/raymondkosasih/"> <i class="ri-linkedin-box-fill"></i></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--
        <div class="bod-slider swiper-container row">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="bod-wrap">
                <div class="bod-item">
                  <img src="{{ asset ('assets/img/bod-list/Dien Natalia.jpg') }}" class="bod-img" alt="">
                  <h3>Dien Natalia</h3>
                  <h4>Founder</h4>
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="bod-wrap">
                <div class="bod-item">
                  <img src="{{ asset ('assets/img/bod-list/Raymond Koh.jpg') }}" class="bod-img" alt="">
                  <h3>Raymond Koh</h3>
                  <h4>Co-Founder & BD</h4>
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  ...
                  <div class="social">
                    <a href="#"><i class="ri-mail-fill"></i></a>
                    <a href="https://www.instagram.com/raymondkosasih/"><i class="ri-instagram-fill"></i></a>
                    <a href="https://www.linkedin.com/in/raymondkosasih/"> <i class="ri-linkedin-box-fill"></i></a>
                  </div>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="bod-wrap">
                <div class="bod-item">
                  <img src="{{ asset ('assets/img/bod-list/Toman Alberto.jpg') }}" class="bod-img" alt="">
                  <h3>Toman Alberto</h3>
                  <h4>Co-Founder & Director</h4>
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
        ...
        <!--
            ...
            <div class="member d-flex align-items-start">
              ...
              <div class="member-info">
                ...
                <!-- style="text-align: justify;" 
                  ...
                  and IT industries. Her expertise includes recruitment...
                </p>
                <div class="learn-more">
                  <a href="/soon" class="more-btn galelry-lightbox">Learn More <i class="bx bx-chevron-right"></i></a>
                </div>
            ...
            <div class="member d-flex align-items-start">
              ...
              <div class="member-info">
                ...
                <p style="text-align: justify;">
                  ...
                  a Client Account Manager. Always interested in HR...
                </p>
                <div class="learn-more">
                  <a href="/soon" class="more-btn galelry-lightbox">Learn More <i class="bx bx-chevron-right"></i></button>
                </div>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
                  <a href=""><i class="ri-facebook-fill"></i></a>
          ...
          <!-- and technology, Raymond started his career as a LinkedIn Talent Solution associate and
                  account executive in an HR recruitment company. He then gained some international
                  work experience with his former IT solutions company. He then joined Dien Natalia
                  establishing Optimus Consulting. Until now, he is really into his dynamic
                  work-life at Optimus.
          ...
          <!-- Living abroad for more than a decade, she started her career in HR with a well-known hotel
          ...
          <div class="col-lg-6 mt-4" data-aos="fade-left" data-aos-delay="100" data-aos-duration="700">
            <div class="member d-flex align-items-start">
              ...
              <div class="member-info">
                ...
                <p style="text-align: justify;">
                  Toman is a relatively newcomer in the human capital industry. Graduated
                  with an engineering degree from ITB, Toman has 10 years’...
                </p>
                <div class="learn-more">
                  <a href="/soon" class="more-btn galelry-lightbox">Learn More <i class="bx bx-chevron-right"></i></button>
                </div>
          ...
          <!-- experience in the oil and gas industry. In 2017, Toman started his journey in one of the
                  HR-tech startups in Indonesia. This exposure to the “new world” had this
                  eye-opening effect on him: he came to realize that the world is so full of
                  opportunities that need to be explored. His grit and curious traits are what
                  brought him to this far: enjoying the whale of a time in Optimus Consulting. -->
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a class="scrollto" href="#main">About Us</a></li>
