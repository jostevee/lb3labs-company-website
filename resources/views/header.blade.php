...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset ('assets/img/logo_optimus.png') }}" rel="icon">
  <link href="{{ asset ('assets/img/logo_optimus.png') }}" rel="apple-touch-icon">

  <!-- Google Fonts -->
  <!-- <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet"> -->

  <!-- Vendor CSS Files -->
  <!-- <link href="{{ asset ('assets/js/jquery.3.2.1.min.js') }}" rel="stylesheet"> -->
  ...
  <link href="{{ asset ('assets/css/style_client.css') }}" rel="stylesheet" type="text/css">
