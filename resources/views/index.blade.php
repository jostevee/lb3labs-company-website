...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a class="logo me-auto"><img src="{{ asset ('assets/img/logo_optimus_navbar.webp') }}" alt="" class="img-fluid"><!-- <h4>Optimus</h4> --></a>

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link">Admin and Writer Page</a></li>
        </ul>
    ...
    <section id="services" class="services hero">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Welcome!</h2>
          <p>
            Please choose one of the menu below to proceed to the next page, thank you!
          </p>
        </div>

        <div class="row">
          <div class="col-lg-6 col-md-6">
            @if ($userwriter==null && $useradmin==null)
              <div class="icon-box" onclick="location.href='/admin/login';" style="cursor: pointer;">
            @elseif ($userwriter==null && $useradmin!=null)
              <div class="icon-box" onclick="location.href='/admin';" style="cursor: pointer;">
            @elseif ($userwriter!=null)
          ...
          <div class="col-lg-6 col-md-6 mt-4 mt-md-0">
            ...
            @elseif ($userwriter!=null && $useradmin==null)
              <div class="icon-box" onclick="location.href='/writer';" style="cursor: pointer;">
