@include('header')
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          -->
          <li class="dropdown"><a class="nav-link scrollto" href="#solutions"><span>Our Solutions</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
    ...
    <div class="container">
      ...
      @else
        ...
        @foreach($event as $data)
          @php
            $content_fix = implode(' ', array_slice(explode(' ', $data->content), 0, 20));
          @endphp
          <div class="swiper-slide">
            <div class="recent-event-wrap">
              <div class="recent-event-item">
                ...
                <!-- <img src="../optimus_consulting_admin/img/{{$data->img_link}}" class="recent-event-img" alt=""> -->
                <!-- <h3>{{$data->title}}</h3> -->

                <!--
                <a href="event/{{$data->id}}" class="galelry-lightbox"><img src="/img/event_list/{{$data->img_link}}" class="recent-event-img" alt="gambar"></a>
                -->
                <a href="/events"><img src="/assets/img/event_list/{{$data->img_link}}" class="recent-event-img" alt="gambar"></a>
  ...
  <main id="main">
    ...
    <section id="clients" class="clients">
      ...
      <div class="clients-slider swiper-container" data-aos="fade-up" data-aos-delay="100" data-aos-duration="700">
        <div class="swiper-wrapper d-flex align-items-center">
          ...
          @php
            $dir = "assets/img/client-list/*.webp";
    ...
    <section id="partner" class="partners">
      ...
      <div class="partners-slider swiper-container" data-aos="fade-up" data-aos-delay="100" data-aos-duration="700" width="70%">
        <div class="swiper-wrapper d-flex align-items-center">

          @php
            $dir = "assets/img/partner-list/*.webp";
            ...
            <div class="swiper-slide" style="text-align: center;">
              <div class="partner-wrap">
                <div class="partner-item">
                  <img src="{{ asset ($image) }}"  alt="partners"/>
                </div>
              </div>
            </div><!-- End testimonial item -->
          @endforeach
        ...
        <div class="row">
            ...
            <div class="count-box">
              ...
              <div class="row">
                ...
                <div class="col-lg-7 d-flex justify-content-start">
                  <span data-purecounter-start="0" data-purecounter-end="4500" data-purecounter-duration="5" class="purecounter">&#177;</span>
                </div>
              </div>
              <p>Clients</p>
            </div>
          ...
          <!-- <div class="col-lg-6 col-md-6 mt-md-0">mt-5
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="120000" data-purecounter-duration="5" class="purecounter"></span>
              <p>Tests</p>
            </div>
          </div> -->
          ...
          <!-- <div class="col-lg-6 col-md-6 mt-5 mt-lg-0">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="65000" data-purecounter-duration="5" class="purecounter"></span>
              <p>Courses</p>
            </div>
          </div> -->
        ...
        <div class="testimonials-slider swiper-container" data-aos="fade-up" data-aos-delay="100">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="{{ asset ('assets/img/testimonial-list/Hedi Nuryanto-Avrist Insurance.webp') }}" class="testimonial-img" alt="">
                  <h3>Hedi Nuryanto</h3>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="{{ asset ('assets/img/testimonial-list/Inez Adelia-Angkasa Pura Support.webp') }}" class="testimonial-img" alt="">
                  <h3>Inez Adelia</h3>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="{{ asset ('assets/img/testimonial-list/Khansa Bianca _ Maria Fransisca-Premiair Group.webp') }}" class="testimonial-img" alt="">
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="{{ asset ('assets/img/testimonial-list/Mirna Oktaviani _ Tina Melinda-Sinarmas Mining.webp') }}" class="testimonial-img" alt="">
                  <h3>Mirna Oktaviani &amp Tina Melinda</h3>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="{{ asset ('assets/img/testimonial-list/Indra Wahyuningsih-Infomedia Nusantara.webp') }}" class="testimonial-img" alt="">
                  <h3>Indra Wahyuningsih</h3>
                  <h4>Infomedia Nusantara</h4>
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                    We would like to thank Optimus Consulting for the assessment that has been done for our company is really incredible 
                    for us. The service that has been done can complete the need of our company. We wish Optimus Consulting for the great 
                    success ahead.
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                  </p>
                </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="{{ asset ('assets/img/testimonial-list/Erlisetya Wahyudi-ASDP.webp') }}" class="testimonial-img" alt="">
                  <h3>Erlisetya Wahyudi</h3>
                  <h4>ASDP Indonesia Ferry Persero</h4>
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                    Our impression while partnering with Optimus Consulting, we are satisfied that we are finally have a partner that could 
                    done recruitment process with a fast pace. Optimus Consulting has the right tools and system that needed for our Company.
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                  </p>
                </div>
              </div>
    ...
    <section id="events" class="gallery services">
      <div class="container">
        ...
        <div class="row d-flex justify-content-center align-items-stretch"><!-- class="section-title" -->
          <div class="col-12 col-md-6 col-lg-6 linkedin-cols d-flex justify-content-stretch align-items-stretch">
            {!!html_entity_decode($social_media-> linkedin_url)!!}
          </div>
          <div class="col-12 col-md-6 col-lg-6 d-flex justify-content-stretch align-items-stretch">
            {!!html_entity_decode($social_media-> instagram_url)!!}
          </div>
        </div>
      </div>
    ...
    <section id="contact" class="contact">
      ...
      <div class="container">
        <div class="row mt-5">
          ...
          <div class="col-lg-4">
            <iframe style="border:0; width: 100%; height: 350px; border-radius: 10px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.2834772147994!2d106.8301963143606!3d-6.226305662710575!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3f03383750f%3A0xed1b28d4a1e935ab!2zTUFSUVVFRSAtIEN5YmVyIOKAi-KAizI!5e0!3m2!1sen!2sid!4v1618022658658!5m2!1sen!2sid" frameborder="0" allowfullscreen></iframe>
          <!--
            <div class="info">
              <div class="address">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form method="POST" class="php-email-form"><!-- role="form" action="/forms/contact"-->
            @csrf
              <div class="row">
                ...
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="email" class="form-control" name="emails" id="emails" placeholder="Your Email" onkeyup="validateEmailField()" required>
                </div>
              </div>
              <div class="form-group mt-3">
              ...
              <div class="text-center"><button type="submit" id="form-submit-button" onclick="return btnClick();">Send Message</button></div>
            </form>
