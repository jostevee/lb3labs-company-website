        ...
        <div class="faq-list">
          ...
          @forelse($faq as $data)
            <li class="faq-list-li" data-aos="fade-up"><!--  data-aos-delay="100" -->
              ...
              <a data-bs-toggle="collapse" class="collapsed" data-bs-target="#faq-list-{{ $data->id }}">{{$data->question}}<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-{{ $data->id }}" class="collapse" data-bs-parent=".faq-list">
                <div class="mx-3 my-3 row d-flex justify-content-stretch">
                  {!! nl2br($data->answer) !!}
                </div>
              </div>
            </li>
          @empty
            <li class="faq-list-li" data-aos="fade-right"> <!-- data-aos-delay="100" -->
              <!-- <i class="bx bx-help-circle icon-help"></i> -->
              <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">Nothing to be found here<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <div class="my-3 row d-flex justify-content-stretch">
                  <p class="text-center">
                    <i>FAQ data isn't available... yet</i>
                  </p>
                </div>
              </div>
            </li>
