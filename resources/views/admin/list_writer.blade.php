...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a class="nav-link active">Writer</a>
            <ul>
  ...
  <main id="main">
    ...
    <!-- Writer List -->
    <section id="list_writer" class="bg-light">
      ...
      <div class="container-fluid">
        ...
        <div class="card-header">Writer List</div>
          <div class="card-body">
              <br>
              ...
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-danger btn-sm" href="/admin/writer/resetpass/{{ $data->id }}">Reset Password</a>
                  </td>
                </tr>
                @endforeach
              </table>
