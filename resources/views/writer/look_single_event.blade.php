    ...
    <section id="services" class="services hero">
      <div class="container">
        ...
        <div class="section-title">
            ...
            <small>Categori: <a href="/category/{{$data->id_category}}">{{$data->category->category}}</a> | Latest Update: {{\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $data->updated_at)->format('d F Y, H:i:s')}}</small> </p>
        </div>
